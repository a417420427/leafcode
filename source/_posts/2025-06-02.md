...
- [Vue 3 源码解析系列博客](https://juejin.cn/post/6844904011556649480)  
  深入浅出讲解 Vue 3 响应式与虚拟 DOM 的优秀中文教程。

- [深入理解 Vue 3 Diff 算法](https://segmentfault.com/a/1190000038299887)  
  分析 Vue 3 中 diff 算法的核心思想和性能优化点。

- [最长递增子序列（LIS）算法介绍 - LeetCode](https://leetcode.cn/problems/longest-increasing-subsequence/)  
  LeetCode 经典算法题及多种实现思路。

- [Evan You 的 Vue 官方博客和视频讲解](https://vuejs.org/blog/)  
  Vue 创始人对 Vue 3 设计理念的官方解读。
